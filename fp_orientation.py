...
def draw_orientation(ax, ori, mask=None, factor=8, stride=32, color="r"):
...
def draw_img_with_orientation(
    img, ori, save_path, factor=8, stride=16, cmap=None, vmin=None, vmax=None, mask=None, color="r"
):
    # plot
    fig = plt.figure()
    ...
    draw_orientation(ax, ori, mask=mask, factor=factor, stride=stride, color=color)
